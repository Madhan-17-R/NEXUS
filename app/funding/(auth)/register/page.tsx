    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-[#0F172A] to-slate-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in relative">
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 shadow-2xl">
          <h1 className="text-2xl font-extrabold text-white mb-1">Apply for Access</h1>
          <p className="text-sm text-slate-400 mb-6">Register your Funding Organization</p>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={cn(
                    ...
                    errors.orgName ? 'border-red-500' : 'border-white/20 focus:border-white/40'
                  )}
                />
              </div>
          ...
          <p className="text-center text-xs text-slate-500 mt-6">
            Already registered?{' '}
            <Link href="/funding/login" className="text-emerald-400 font-bold hover:text-emerald-300">
              Sign in
            </Link>
          </p>
        </div>
