...
export default function FundingLoginPage() {
  const router = useRouter();
  const [tab, setTab] = useState<LoginTab>('email');

  // Email+Password state
  const [email, setEmail] = useState('admin@horizontech.vc');
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-[#0F172A] to-slate-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in relative">
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 shadow-2xl">
          <h1 className="text-2xl font-extrabold text-white mb-1">Enterprise Login</h1>
          <p className="text-sm text-slate-400 mb-6">Access your Funding Organization dashboard</p>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="admin@horizontech.vc"
                    className={cn(
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link href="#" className="text-xs font-bold text-emerald-400 hover:text-emerald-300">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
          ...
          <p className="text-center text-xs text-slate-500 mt-6">
            ...
            <Link href="/funding/register" className="text-emerald-400 font-bold hover:text-emerald-300">
              Apply for Access
            </Link>
          </p>
        </div>
